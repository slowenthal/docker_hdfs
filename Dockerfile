...
# Install hadoop
ADD hadoop/hadoop-${HADOOP_VERSION}.tar.gz /opt
...
COPY config/core-site.xml.client ${HADOOP_PREFIX}/share/hadoop/hdfs/webapps/hdfs/core-site.xml
COPY config/hdfs-site.xml.client ${HADOOP_PREFIX}/share/hadoop/hdfs/webapps/hdfs/hdfs-site.xml
...
################### Expose volumes
VOLUME ["/opt/hadoop/logs", "/var/lib/hadoop"]


################### Entry point
#ENTRYPOINT [ "/root/docker_entrypoint.sh" ]

## Fix up hadoop web ui.
RUN sed -i 's#/static/#static/#' /opt/hadoop/share/hadoop/hdfs/webapps/hdfs/dfshealth.html   \
